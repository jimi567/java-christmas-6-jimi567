...
- [ ] 주문 음식에 대한 유효성 검사 테스트
    - [ ] 메뉴판에 존재하는 메뉴가 아닐 경우 테스트
    - [ ] 메뉴의 개수가 1개 이상이 아닐 경우 테스트
    - [ ] 총 주문 갯수가 20개 이하가 아닐 경우 테스트
    - [ ] 음료만 주문했을 경우 테스트
- [ ] 메뉴의 총 금액을 리턴하는 기능 테스트
- [ ] 디저트 메뉴의 갯수를 리턴하는 기능 테스트
- [ ] 메인 메뉴의 개수를 리턴하는 기능 테스트
- [ ] 음료 메뉴의 개수를 리턴하는 기능 테스트
- [ ] 에피타이저 메뉴의 개수를 리턴하는 기능 테스트
