...
- [ ] VisitDay interface
    ...
    - [ ] 방문날짜가 디데이 이벤트 적용이 가능한지 리턴하는 기능
    - [ ] 방문날짜가 디데이(크리스마스)와 며칠 차이 나는지 리턴하는 기능
- [ ] DecemberVisitDay
    - [ ] 날짜에 대한 유효성 검사
        - [ ] 1~31사이의 정수인지?
    - [ ] 해당 날이 12월에서 주말이벤트 날인지(금,토) 리턴하는 기능
    - [ ] 해당 날이 12월 달력에 별이 있는 날인지를 리턴하는 기능
    - [ ] 해당 날이 디데이 이벤트 기간에 속하는지 리턴하는 기능
    - [ ] 해당 날이 디데이 이벤트 일(크리스마스) 와 며칠만큼 차이가 나는지 리턴하는 기능
