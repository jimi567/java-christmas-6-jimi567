...
public enum Error {
    ...
    ORDER_ONLY_DRINK_ERROR(ERROR.get() + "음료만 주문 시, 주문할 수 없습니다." + RETRY_PROMPT.get()),
    ORDER_OVER_QUANTITY_ERROR(ERROR.get() + "메뉴는 한 번에 최대 20개까지만 주문할 수 있습니다." + RETRY_PROMPT.get()),
